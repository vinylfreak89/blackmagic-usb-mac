...
older provisional crops. While the physical gauge remains authorized, comb
continues to be logged as a diagnostic but cannot install a fallback that
overrides those per-field landmarks.
