...
print("\n  for comparison, from dither_compare.py on the same capture -- ⚠️ both WITHDRAWN:")
print("    undisplaced blanking  -0.292      clipped dark picture  +0.274")
print("    (that comparison computed lag-1 on a boolean-mask SELECTION whose adjacent elements")
print("     were not adjacent in time. Shown as the figure this run replaces, never as a baseline.)")
