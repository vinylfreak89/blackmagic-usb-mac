...
static int log_field(FILE *L, const fieldreg_field_decision *d)
{
    ...
    return fprintf(L, ",%s,%s,%d,%s,%s,%u,%u,%d,%s,%.3f,%d,%.3f,%d,%d,%d,%d,%d,%s,%s,%u,%d,%d,%d,%s,%d,%d,%d,%d",
