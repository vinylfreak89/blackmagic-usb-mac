...
for i,(top,hi) in enumerate(((23,13),(24,13),(24,13),(24,14),(0,13),(25,13))):
...
stream.extend(fixture.unit(106)[:100])
with tempfile.TemporaryDirectory(prefix='near-blank-',dir='/private/tmp') as tmp:
    ...
    for reverse in (False,True):
        ...
        for audit in (False,True):
            ...
            assert len(units)==6 and all(r['published']=='1' for r in units.values()),p.stdout
