...
for arm,expected in [({},'# GE_WAVE_BAR=0.45000000000000001 GE_WAVE_CLAMP=5 GE_COMB_REJECT=2'),
    ...
    with tempfile.TemporaryDirectory(prefix='wave-controls-',dir='/private/tmp') as tmp:
        ...
        assert p.stdout.splitlines()[0]==audit.read_text().splitlines()[0]==expected+' GE_ANCHOR_VOTE=0 GE_LEVEL_FILL=0 GE_LEVEL_FLAT=0 GE_VOTE_PAIR=0 GE_VOTE_PAIR_MIN=0.59999999999999998 GE_BOTTOM_FLAT=0 GE_BOTTOM_FLAT_MARGIN=3 GE_VOTE_BLANKSPOT=0 GE_COMB_STILL=0 GE_COMB_MOTION_MIN=1'
