...
class _CFieldRegistrationDecision(ctypes.Structure):
    _fields_ = (
        ...
        ("comb_input_second_energy", ctypes.c_double),
        ("comb_input_static_fraction", ctypes.c_double),
        ("comb_check", ctypes.c_int),
...
class CRegistrationEstimator:
    ...
    def decide(self, unit: bytes) -> dict[str, object]:
        ...
        return {
            ...
            "comb_input_best_energy": result.comb_input_best_energy,
            "comb_input_second_energy": result.comb_input_second_energy,
            "comb_input_static_fraction": result.comb_input_static_fraction,
...
TPC_DECISION_COLUMNS = (
    ...
    "comb_published_best_energy", "comb_published_second_energy",
    "comb_published_static_fraction", "segment_id",
    "presentation_policy",
    ...
    if "fields" in registration:
        ...
        return (
            ...
            *registration["baseline"], registration["mode"],
            ...
            f"{registration['comb_input_static_fraction']:.6f}",
            registration["comb_check"], registration["comb_best_shift"],
            registration["parity_bias"],
