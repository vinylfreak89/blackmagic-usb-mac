                      ...
                      int *f1_hold_length, int *f2_hold_length)
{
    ...
    return sscanf(line, "%u,%95[^,],%d,%d,%d,%d,%d,%47[^,],%47[^,],%23[^,],%23[^,],%23[^,],%23[^,],%d,%d,%d,%d,%d,%d,%d,%d,%d,%23[^,],%23[^,],%d,%23[^,],%23[^,],%23[^,],%d,%d,%d,%d,%d,%d",
                  ...
                  parity_bias, gap_state, f1_hold_cause, f2_hold_cause,
                  f1_saved_d, f2_saved_d, f1_geometry_jump,
                  f2_geometry_jump, f1_hold_length, f2_hold_length) == 34;
}
...
int main(int argc, char **argv)
{
    ...
    while (read_truth(truth, &index, scenario, &begin, &discontinuity,
        ...
        if (actual_ok) {
            ...
            if (strcmp(expected_gap_state, "-") != 0)
                match = match && strcmp(fieldreg_gap_state_name(
                    decision.gap_state), expected_gap_state) == 0;
